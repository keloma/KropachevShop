...
<html>
    <head>
        ...
        <title>Дейсвия с товарами</title>
  ...
  <header>
    ...
    <nav>
      <div class="nav-wrapper indigo darken-2">
        <a style="margin-left: 20px;" class="breadcrumb" href="controller?command=allProduct">Дейсвия с товарами</a>
          ...
          <div class="row">
                ...
                <div class="col s6">
                    <div class="single-special text-center wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <p>${product.male}</p>
                        <p>${product.size}</p>
                        <p>${product.price} евро</p>
                        <button type="button"  id="allbr"><a href="controller?command=deleteProduct&id=${product.id}">Удалить</a></button>
                        <button type="button" id="allbr"><a href="controller?command=editProduct&id=${product.id}">Изменить</a></button>
                    </div>
                </div>
                </c:forEach>
          </div>
