  ...
  <header>
    ...
    <nav>
      <div class="nav-wrapper indigo darken-2">
        <a style="margin-left: 20px;" class="breadcrumb" href="controller?command=allMessage">Дейсвия с сообщениями</a>
          ...
          <div class="row">
                ...
                <div class="col s6">
                    <div class="single-special text-center wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <p>${message.email}</p>
                        <button type="button"  id="allbr"><a href="controller?command=deleteMessage&id=${message.id}">Удалить</a></button>
                    </div>
                </div>
                </c:forEach>
          </div>
