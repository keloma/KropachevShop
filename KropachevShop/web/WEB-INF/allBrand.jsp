...
<html>
    <head>
        ...
        <title>Дейсвия с брендами</title>
  ...
  <header>
    ...
    <nav>
      <div class="nav-wrapper indigo darken-2">
        <a style="margin-left: 20px;" class="breadcrumb" href="controller?command=allBrand">Дейсвия с брендами</a>
          ...
          <div class="row">
                ...
                <div class="col s6">
                    <div class="single-special text-center wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <button type="button"  id="allbr"><a href="controller?command=deleteBrand&id=${brand.id}">Удалить</a></button>
                        <button type="button" id="allbr"><a href="controller?command=editBrand&id=${brand.id}">Изменить</a></button>
                    </div>
                </div>
                </c:forEach>
          </div>
