  ...
  <header>
    ...
    <nav>
      <div class="nav-wrapper indigo darken-2">
        <a style="margin-left: 20px;" class="breadcrumb" href="controller?command=addFaq">Добавление</a>
    ...
    <div class="row col-md-12">
      <div class="col s6">
        <div style="padding: 35px;" align="center" class="card">
          ...
          <div class="row">
            <form action="controller?command=addNewFaq" method="POST">
                ${info}
                <div class="form-group">
                  <label for="user-name"></label>
                  <input type="text" name="name" class="form-control" id="user-word" placeholder="Вопрос">
                </div>
                
                <div class="form-group">
                  <label for="user-description"></label>
                  <textarea class="form-control" name="answer" id="user-description" rows="8" placeholder="Ответ"></textarea>
                </div>
