    ...
    <div class="row col-md-12">
      <div class="col s6">
        <div style="padding: 35px;" align="center" class="card">
          ...
          <div class="row">
            <form action="controller?command=doChangeFaq" method="POST">
                <div class="form-group">
                  <input type="hidden" name="faq_id"  value="${editFaq.id}">
                  <label for="user-name"></label>
                  <input type="text" name="name" class="form-control" id="user-word" value="${editFaq.name}">
                </div>
                
                <div class="form-group">
                  <label for="user-image"></label>
                  <input type="text" name="answer" class="form-control" id="user-trans" value="${editFaq.answer}">
                </div>
