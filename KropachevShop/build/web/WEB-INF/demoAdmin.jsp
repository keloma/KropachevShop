<%-- 
    Document   : demoAdmin
    Created on : May 14, 2018, 10:17:56 AM
    Author     : pupil
--%>
  ...
  <header>
    ...
    <nav>
      <div class="nav-wrapper indigo darken-2">
        <a style="margin-left: 20px;" class="breadcrumb" href="controller?command=panelAdmin">Назначение на роль</a>
      ...
      <div class="col s6">
        <div style="padding: 35px;" align="center" class="card">
          ...
          <div class="row">
                      ...
                      <form action="controller?command=setRole" name="setrole" method="POST">
            ...
            <input class="roles-roles" type="submit" value="Назначить">
        </form>
