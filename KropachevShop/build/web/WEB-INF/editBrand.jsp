  ...
  <header>
    ...
    <nav>
      <div class="nav-wrapper indigo darken-2">
        <a style="margin-left: 20px;" class="breadcrumb" href="controller?command=editBrand">Редактирование</a>
    ...
    <div class="row col-md-12">
      <div class="col s6">
        <div style="padding: 35px;" align="center" class="card">
          ...
          <div class="row">
            <form action="controller?command=doChangeBrand" method="POST">
                <div class="form-group">
                  <input type="hidden" name="brand_id"  value="${editBrand.id}">
                  <label for="user-name"></label>
                  <input type="text" name="name" class="form-control" id="user-word" value="${editBrand.name}">
                </div>
                
                <div class="form-group">
                  <label for="user-image"></label>
                  <input type="text" name="image" class="form-control" id="user-trans" value="${editBrand.image}">
                </div>
                
                <div class="form-group">
                  <label for="user-description"></label>
                  <textarea class="form-control" name="description" id="user-description" rows="8">${editBrand.description}</textarea>
                </div>
