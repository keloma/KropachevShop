  ...
  <header>
    ...
    <nav>
      <div class="nav-wrapper indigo darken-2">
        <a style="margin-left: 20px;" class="breadcrumb" href="controller?command=addBrand">Добавление</a>
    ...
    <div class="row col-md-12">
      <div class="col s6">
        <div style="padding: 35px;" align="center" class="card">
          ...
          <div class="row">
            <form action="controller?command=addNewBrand" method="POST">
                ${info}
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="image" class="form-control" id="user-trans" placeholder="Логотип">
                </div>
                
                <div class="form-group">
                  <label for="user-description"></label>
                  <textarea class="form-control" name="description" id="user-description" rows="8" placeholder="Описание"></textarea>
                </div>
