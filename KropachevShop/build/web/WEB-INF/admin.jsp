...
<html>
    ...
    <ul class="collapsible" data-collapsible="accordion">
      ...
      <li id="dash_brands">
       ...
       <li id="dash_brands">
        <div id="dash_brands_header" class="collapsible-header waves-effect"><b>FAQ</b></div>
        <div id="dash_brands_body" class="collapsible-body">
          <ul>
            <li id="brands_brand">
  ...
  <header>
    ...
    <nav>
      <div class="nav-wrapper indigo darken-2">
        <a style="margin-left: 20px;" class="breadcrumb" href="controller?command=admin">Главная</a>
    ...
    <div class="row">
      <div class="col s6">
        <div style="padding: 35px;" align="center" class="card">
          ...
          <div class="row">
            <a href="controller?command=panelAdmin">
              <div style="padding: 30px;" class="grey lighten-3 col s12 waves-effect">
                ...
                <span class="indigo-text text-lighten-1"><h5>Назначить</h5></span>
              </div>
            </a>
          </div>
        </div>
