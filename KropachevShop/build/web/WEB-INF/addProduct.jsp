  ...
  <header>
    ...
    <nav>
      <div class="nav-wrapper indigo darken-2">
        <a style="margin-left: 20px;" class="breadcrumb" href="controller?command=addProduct">Добавление</a>
    ...
    <div class="row col-md-12">
      <div class="col s6">
        <div style="padding: 35px;" align="center" class="card">
          ...
          <div class="row">
            <form action="controller?command=addNewProduct" method="POST">
                ${info}
                <div class="form-group">
                  <label for="user-name"></label>
                  <input type="text" name="name" class="form-control" id="user-word" placeholder="Название">
                </div>
                
                <div class="form-group">
                  <label for="user-image"></label>
                  <input type="text" name="price" class="form-control" id="user-trans" placeholder="Цена">
                </div>
                
                 <div class="form-group">
                  <label for="user-image"></label>
                  <input type="text" name="image" class="form-control" id="user-trans" placeholder="Картинка">
                </div>
                
                 <div class="form-group">
                  <label for="user-image"></label>
                  <input type="text" name="size" class="form-control" id="user-trans" placeholder="Размер">
                </div>
                
                 <div class="form-group">
                  <label for="user-image"></label>
                  <input type="text" name="brand" class="form-control" id="user-trans" placeholder="Производитель">
                </div>
                
                 <div class="form-group">
                  <label for="user-image"></label>
                  <input type="text" name="male" class="form-control" id="user-trans" placeholder="Пол">
                </div>
                
                <button type="submit" class="roles-roles">Добавить</button>
            </form>
          </div>
        </div>
      </div>
